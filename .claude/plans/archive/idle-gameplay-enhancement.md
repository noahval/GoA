...
5. [Phase 5: Own Furnace & Worker Management](#phase-5-own-furnace--worker-management)
   - Unlock Timing
   - Worker Treatment System (Poor/Fair/Good)
   - Harmful Furnace Upgrades
6. [Phase 6: Environmental Management Systems](#phase-6-environmental-management-systems-split-into-sub-phases)
