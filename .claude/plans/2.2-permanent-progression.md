...
- Maximum: 45% auto-shovel chance (15% per path × 3 paths)
...
**Previous Phase**: [2.1-core-loop-mvp.md](2.1-core-loop-mvp.md)
**Next Phase**: [2.3-roguelite-techniques.md](2.3-roguelite-techniques.md)
