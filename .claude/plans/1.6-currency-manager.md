...
- **Phase 1.5 (Currencies)**: Data storage (currency dictionaries, unlocks)
- **This phase (1.6)**: Operations (exchange, fees, capacity, market hooks)
- **Phase 1.7 (ATM Scene)**: UI (display, user input, visual feedback)
- **Phase 3.1 (Market Volatility)**: Dynamics (updates modifiers in _process)
...
- 2 hours: CurrencyManager structure, fee system
- 2 hours: Exchange preview and execution
- 1.5 hours: Capacity system and purse upgrades
- 1 hour: Helper functions and market rate display
- 1.5 hours: Unit tests
- 1 hour: Manual testing and polish

**Dependencies Complete**: Yes - Assumes Phases 1.3 and 1.5 complete

**Previous Phase**: [1.5-currencies.md](1.5-currencies.md)

**Next Phase**: 1.7 - ATM Scene (UI implementation)
