...
- Player receives 1 holes currency per day (punched timecard flavor text)
...
│       │   │           └── TimecardLabel (Label - "Your timecard was punched, you keep the punched paper.")
...
- Awards 1 holes currency per day (punched timecard flavor)
- Timecard label provides thematic explanation for holes currency
...
- [ ] Timecard label displays "Your timecard was punched, you keep the punched paper."
- [ ] 1 holes currency awarded on scene load
...
|           |                                           |          |
|           |  Pay: 3 copper                            |          |
|           |  Your timecard was punched, you keep      |          |
|           |  the punched paper.                       |          |
|           |                                           |          |
|           |            [ Dorm ]                       |          |
|           +-------------------------------------------+          |
