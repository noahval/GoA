...
furnace --> n1["Mind"]
```
- **Furnace** gets Forward Nav button: `ToMindButton` with text "To Mind"
- **Mind** gets Back Nav button: `ToFurnaceButton` with text "To Furnace"

```
dorm --> bar & carriage
```
- **Dorm** gets two Forward Nav buttons:
  - `ToBarButton` with text "To Bar"
  - `ToCarriageButton` with text "To Coppersmith Carriage"
- **Bar** gets Back Nav button: `ToDormButton` with text "To Dormitory"
- **Carriage** gets Back Nav button: `ToDormButton` with text "To Dormitory"
...
- [ ] Navigation button text follows format ("To X")
