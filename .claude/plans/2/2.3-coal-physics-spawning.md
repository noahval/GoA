...
- Uses `Shovel` RigidBody2D from 2.x-physics-objects-setup.md
...
- [ ] Shovel tilt (via click) causes coal to slide naturally
...
1. Scoop coal
2. Left-click to tilt shovel left
3. Expected: Coal slides toward right (lower side)
4. Right-click to tilt shovel right
...
1. Tilt shovel (left or right click)
...
**Shovel tilt gameplay**:
- Tilt creates gravity component perpendicular to surface
- Coal naturally slides "downhill" on tilted shovel
