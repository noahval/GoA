...
- **Short description**: Quality-modified value injected with BBCode color, centered. Reductions show negative (e.g., stamina drain `-22%`), increases show positive (e.g., mass `+15%`). Example: `"[center]Base stamina drain [color=#4ccc4c]-22%[/color][/center]"` (ShortDescriptionLabel - 15px)
...
**Version**: 5.10 (Mass display fix)
**Supersedes**: Plans 2.12-upgrade-pool.md, 2.13-apply-upgrade.md, and 2.14-shovelling-level-up.md

**Changelog v5.10** (2026-01-07):
- **FIX**: Mass category techniques now display as positive percentages (+X%) instead of negative
- Firm Grip and Mass Training show "+15%" and "+2%" respectively (mass increases are good)
