# Coal Tracking System (Shovelling Phase 3)
...
**Dependencies**:
- Requires Phase 2.2.2 (coal physics & spawning) to be complete
- Requires Level1Vars autoload (should exist from base systems)
