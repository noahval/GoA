...
**Shovel Mass**:
- [ ] Firm Grip increases shovel mass (multiplicative stacking)
- [ ] Mass Training dynamically scales mass with combo
- [ ] Shovel mass updates when combo changes (if Mass Training active)
...
- [ ] Test Firm Grip increases mass (multiplicative stacking)
- [ ] Test Mass Training scales mass dynamically with combo
- [ ] Test mass updates when combo changes (if Mass Training active)
...
**Version**: 5.7 (Heavy load rebalance + technique renames)
