...
- **Short description**: Quality-modified value injected with BBCode color, centered. Example: `"[center]Base stamina drain [color=#4ccc4c]-22%[/color][/center]"` (ShortDescriptionLabel - 15px)
