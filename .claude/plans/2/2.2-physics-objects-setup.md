...
func _ready():
    ...
    lock_rotation = true  # Keep shovel level (tilt mechanic disabled for now)
...
Note: No input handling needed - tilt mechanic disabled for phase 2.2
...
- mass (5.0): Shovel weight - lower = easier for coal to push, higher = more stable

**Why lock_rotation = true?**
- Tilt mechanic disabled for phase 2.2 to focus on basic collision working
- Keeping shovel level simplifies physics and ensures coal lands properly
- Tilt mechanic can be added later in phase 2.3 once basic shoveling works
