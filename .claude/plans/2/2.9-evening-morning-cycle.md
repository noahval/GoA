...
- daily_reset.md file documents all variables reset at end of each day
...
- `player_level` - Shoveling mastery persists
...
- Text: "Eat Rations"
- Theme type variation: "ForwardNavButton" (light blue)
...
- [ ] player_level persists after sleep
- [ ] player_exp persists after sleep
...
**Level1Vars Updates:**
- [ ] Add `hungry: bool = false` variable
- [ ] Add `hunger_skip: bool = false` variable
- [ ] Add `rage: int = 0` variable
- [ ] Add `whip_count: int = 0` variable
- [ ] Add `stamina_restore_eating: float = 30.0` variable
- [ ] Add `stamina_restore_sleeping: float = 20.0` variable
- [ ] Add `hunger_changed(is_hungry: bool)` signal
- [ ] Add `perform_daily_reset()` function that calls reset_techniques()
- [ ] Add hungry, hunger_skip, rage, whip_count to get_save_data()
- [ ] Add hungry, hunger_skip, rage, whip_count to load_save_data()

**Pay Scene:**
- [ ] Set `Level1Vars.hungry = true` in _ready()
- [ ] Call `Level1Vars.hunger_changed.emit(true)`

**Mess Scene:**
- [ ] Add StaminaBar ProgressBar to mess.tscn Menu
- [ ] Add EatRationsButton to mess.tscn Menu (visible: false by default)
- [ ] Add @onready reference for stamina_bar
- [ ] Add @onready reference for eat_rations_button
- [ ] Implement connect_stamina_bar() with signal connection
- [ ] Implement _on_stamina_changed() handler
- [ ] Implement connect_eat_button() with hunger signal connection
- [ ] Implement _update_eat_button_visibility()
- [ ] Implement _on_hunger_changed() handler
- [ ] Implement _on_eat_rations_pressed() with stamina_restore_eating
- [ ] Implement _exit_tree() with signal disconnection

**Dorm Scene:**
- [ ] Add SleepButton to dorm.tscn Menu
- [ ] Add @onready reference for sleep_button
- [ ] Add @onready reference for play_area
- [ ] Implement connect_sleep_button()
- [ ] Implement _on_sleep_pressed() with hunger check
- [ ] Implement do_sleep() with stamina restore and perform_daily_reset()
- [ ] Implement show_hunger_warning_popup() with styled panel
- [ ] Implement _on_hunger_warning_ok() to set hunger_skip and hide popup
- [ ] Verify transition to dream scene works

**Dream Scene:**
- [ ] Add WakeButton to dream.tscn Menu
- [ ] Add @onready reference for wake_button
- [ ] Implement connect_wake_button()
- [ ] Implement _on_wake_pressed()
