...
func get_xp_for_level(level: int) -> float:
	...
	# Exponential curve: BASE_XP * (level - 1) ^ EXP_SCALING
...
2. **Level-Up Notification**:
   ...
   - Deliver that many coal pieces (approximately 100 coal for level 2)
...
- Level 2: ~12 XP (12 coal)
- Level 3: ~27 XP (15 more coal)
- Level 4: ~44 XP (17 more coal)
- Level 5: ~63 XP (19 more coal)
