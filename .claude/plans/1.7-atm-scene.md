...
- 2 hours: Scene setup and UI layout
- 1 hour: Market rates display
- 2 hours: Exchange interface and preview
- 1 hour: Purse panel and capacity display
- 1 hour: Responsive layout integration
- 1 hour: Testing and polish

**Dependencies Complete**: Yes - Assumes Phases 1.3, 1.5, 1.6 complete

**Previous Phase**: [1.6-currency-manager.md](1.6-currency-manager.md)

**Next Phase**: 2.x - Copper Era plans (use this ATM scene)
