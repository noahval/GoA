# Phase 1.8: Stats & Experience System
...
- 0.5 hours: Review/cleanup existing global.gd implementation
- 0.5 hours: Update save/load managers
...
**Next Phase**: 2.9 - Stat Progression Mechanics (which actions award XP, pacing)
