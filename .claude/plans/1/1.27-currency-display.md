...
- 1.x-currency-manager.md (Global.refresh_all_currency_displays() helper MUST be implemented first)
...
func is_currency_unlocked() -> bool:
	...
	match currency_type:
		...
		"silver":
			return Level1Vars.get("unlocked_silver", false)
		"gold":
			return Level1Vars.get("unlocked_gold", false)
		"platinum":
			return Level1Vars.get("unlocked_platinum", false)
		_:
			return false
```
...
func test_is_currency_unlocked_returns_false_for_locked():
	Level1Vars.set("unlocked_silver", false)  # Ensure silver locked
...
- [ ] Verify Global.refresh_all_currency_displays() exists (from 1.x-currency-manager.md)
- [ ] Copper icon created at `res://level1/icons/copper.png` BEFORE writing code
