...
### 9. Global Currency Display Refresh Helper

**IMPORTANT**: This helper must be implemented EARLY (before CurrencyDisplay component is used)

**Purpose**: Refresh all CurrencyDisplay UI components after currency transactions

**File**: Add to `game/v0.1/global.gd`
...
**Integration**: See 1.x-currency-display.md for CurrencyDisplay component implementation
...
**game/v0.1/global.gd** (~10 lines added)
- refresh_all_currency_displays() function
...
- [ ] Function tested with CurrencyDisplay component
...
**Plan Version**: 1.1 (Added Global.refresh_all_currency_displays() helper)
