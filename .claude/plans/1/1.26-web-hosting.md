...
- [ ] Create itch.io project for GoA
- [ ] Configure itch.io project (HTML5, SharedArrayBuffer support)
- [ ] Generate itch.io API key
- [ ] Add ITCH_API_KEY to GitHub secrets
- [ ] Add ITCH_USER to GitHub secrets
- [ ] Add ITCH_GAME to GitHub secrets
- [ ] Update GitHub Actions workflow for itch.io deployment
- [ ] Delete Cloudflare Pages project (no longer needed)
- [ ] Delete CLOUDFLARE_API_TOKEN and CLOUDFLARE_ACCOUNT_ID secrets
