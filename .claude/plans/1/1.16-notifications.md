...
- Click notification bar opens history panel (links to Plan 1.x-notification-history-panel)
...
- **History tracking**: All notifications saved for history panel (Plan 1.x-notification-history-panel)
...
- **Plan 1.x-notification-history-panel**: History panel UI in play area (filter, scroll, close)
...
# Complete history (for history panel - Plan 1.x-notification-history-panel)
...
func show_notification(message: String, type: NotificationType = NotificationType.INFO) -> void:
    ...
    # Add to history (for Plan 1.x-notification-history-panel history panel)
...
func _setup_notification_bar_click(notification_bar: Control) -> void:
    ...
    Links to Plan 1.x-notification-history-panel (Notification History Panel).
    """
    ...
    # Connect to history panel opener (implemented in Plan 1.x-notification-history-panel)
...
func _on_notification_bar_clicked() -> void:
    ...
    Implementation in Plan 1.x-notification-history-panel.
    """
    # TODO: Open NotificationHistoryPanel in play area
    # See Plan 1.x-notification-history-panel for implementation
    pass
```

**Future**: Plan 1.x-notification-history-panel implements full history panel UI
...
**Note**: Can defer persistence to Plan 1.x-notification-history-panel if history is session-only
...
- [ ] Click notification bar - history panel opens (Plan 1.x-notification-history-panel)
...
- `scene_template.tscn` (minor - optional)
  - Add click handler to NotificationBar (for Plan 1.x-notification-history-panel)
...
- **Plan 1.x-notification-history-panel** (Notification History Panel) - Reads notification_history array
...
**History Panel (Plan 1.x-notification-history-panel)**:
```gdscript
...
- **Implementation**: Stub in this plan, full UI in Plan 1.x-notification-history-panel
...
- [ ] Click handler stub added (links to Plan 1.x-notification-history-panel)
- [ ] Notifications persist across scene changes
