...
# Note: is_loading_cloud_save flag suppresses notifications during cloud save load
var strength: int = 1:
	set(value):
...
# ========================================
# SAVED SETTINGS (Persists During Reset)
# ========================================
# Settings are stored in save_data.settings section
# They survive save resets and prestige operations

# ===== UI SETTINGS =====
var ui_scale: float = 1.0  # User preference for UI scaling (stored in save_data.settings)
```
...
**UPDATE (Phase 1.14-1.15):** Settings are now managed through Global.save_data.settings instead of a separate SettingsManager autoload. This section is kept for reference but has been superseded by the structured save system in Global.gd (see Phase 1.14-1.15 implementation).
